...
class _$CarImpl implements _Car {
  ...
  @override
  String toString() {
    return 'Car(id: $id, color: $color, brand: $brand, model: $model, price: $price)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, color, brand, model, price);
...
abstract class _Car implements Car {
  factory _Car(
      ...
      @DoubleToString() final double price) = _$CarImpl;
